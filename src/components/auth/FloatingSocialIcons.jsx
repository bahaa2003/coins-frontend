      ...
      {items.map(({ id, Icon, label, meta, className, delay }) => (
        ...
        >
          <div className={cn(
            ...
            <span className={cn(
              'relative flex items-center justify-center rounded-full border border-[color:rgb(var(--color-primary-rgb)/0.28)] bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.68),rgba(29,149,168,0.12)_44%,rgba(255,248,236,0.9)_100%)] text-[var(--color-primary)] shadow-[0_8px_18px_-14px_rgba(29,149,168,0.46)] dark:bg-[radial-gradient(circle_at_top,rgba(125,249,255,0.18),rgba(29,149,168,0.08)_44%,rgba(10,12,16,0.24)_100%)] dark:text-[#f0c85a] dark:shadow-[0_10px_24px_-16px_rgba(125,249,255,0.75)]',
            ...
            <span className="relative flex flex-col leading-none">
              ...
              <span className="mt-1 inline-flex items-center gap-1 text-[0.42rem] uppercase tracking-[0.1em] text-[var(--color-muted)] sm:text-[0.46rem] dark:text-[#f8f1da]/52 lg:text-[0.52rem]">
                <span className="h-1.5 w-1.5 rounded-full bg-[var(--color-primary)] dark:bg-[#f0c85a]" />
                {meta}
              </span>
            </span>
          </div>
