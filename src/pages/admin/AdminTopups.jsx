        ...
        {topups.map((topup) => (
          <article key={topup.id} className="admin-premium-panel p-4">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              {topup.status === 'pending' && topup.type === 'game_topup' && (
                <span className="rounded bg-teal-100 px-2 py-1 text-xs font-medium text-teal-700 dark:bg-teal-900/20 dark:text-teal-300">
                  تلقائي
                </span>
              )}
            </div>
          ...
          <div className="space-y-6">
            ...
            {detailsTopup.type === 'game_topup' && detailsTopup.gameDetails && (
              <div>
                ...
                <div className="space-y-2 rounded-lg bg-teal-50 p-4 dark:bg-teal-900/20">
                  <div className="flex items-center justify-between gap-3">
