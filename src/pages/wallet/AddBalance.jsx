        ...
        >
          <div className={`flex items-center justify-between ${isRTL ? 'flex-row-reverse' : ''}`}>
            <div className={`flex items-center gap-3 ${isRTL ? 'flex-row-reverse' : ''}`}>
              <div className="w-10 h-10 rounded-lg bg-gradient-to-r from-orange-400 to-yellow-500 flex items-center justify-center">
                ...
                <div className={`mb-4 ${isRTL ? 'text-right' : 'text-left'}`}>
                  <div className={`flex items-center gap-3 mb-2 ${isRTL ? 'flex-row-reverse' : ''}`}>
                    {group.image ? (
                      ...
                      <div className="w-8 h-8 rounded-lg bg-gradient-to-r from-orange-400/20 to-yellow-500/20 border border-white/10 flex items-center justify-center">
