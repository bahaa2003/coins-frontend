    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900" dir={dir}>
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-orange-400/20 to-yellow-500/20 backdrop-blur-xl border border-orange-400/30 rounded-xl p-6 mb-8"
        >
        ...
        >
          ...
          <motion.button
            ...
            type="submit"
            className="w-full bg-gradient-to-r from-orange-400 to-yellow-500 text-white py-4 rounded-xl font-semibold hover:shadow-lg hover:shadow-orange-500/25 transition-all flex items-center justify-center gap-2"
          >
            {isSubmitting ? (
              <>
