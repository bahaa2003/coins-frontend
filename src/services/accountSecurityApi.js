...
const accountSecurityApi = {
  ...
  async sendEmailCode({ userId, email }) {
    ...
    return {
      ...
      qrCodeUrl: `https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=${encodeURIComponent(`otpauth://totp/COINS STORES:${email}?secret=COINSSTORE${userId}&issuer=COINS STORES`)}`
    };
  },
